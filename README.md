...
I would say that semantic HTML is like the structure/framework (framing, drywall, etc.) of a house. It gives structure to your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block will display items in column form, while display inline will display the items side by side. 
...
Because it allows developers to work together and contribute to the same project. 
